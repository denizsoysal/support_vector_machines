...
for degree=degree_list,
    disp('Polynomial kernel of degree'),
...
%
disp('RBF kernel - sig tuning')
gam = 1; sig2list=[0.01,0.1,1,5,10];
...
%
disp('RBF kernel - gamma tuning')
gamlist = [0.001, 0.01, 0.1, 1,5,10,25,50,100,250]; sig2=1;
